# services/models/professional.py
...
class ProfessionalService(ServiceBaseModel):
    ...
    vendor = models.ForeignKey(Vendor, on_delete=models.CASCADE, related_name="professional_services")
    ...
    # Images
    main_image = models.ImageField(upload_to='professional_services/', null=True, blank=True)
    multi_images = models.ManyToManyField('ProfessionalServiceImage', blank=True)
    ...
    approved_by = models.ForeignKey(
        ...
        related_name='approved_professional_services'
    )
...
class ProfessionalServiceImage(models.Model):
