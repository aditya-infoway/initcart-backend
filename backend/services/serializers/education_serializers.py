...
class EducationNewServiceImageSerializer(serializers.ModelSerializer):
    image = serializers.SerializerMethodField()

    class Meta:
        model = EducationNewServiceImage
        fields = ['id', 'image']
...
class EducationNewServiceSerializer(serializers.ModelSerializer):
    ...
    multi_images = EducationNewServiceImageSerializer(many=True, required=False)
    main_image = serializers.SerializerMethodField()
    approved_date = serializers.DateTimeField(read_only=True)

    class Meta:
        model = EducationNewService
        fields = [
