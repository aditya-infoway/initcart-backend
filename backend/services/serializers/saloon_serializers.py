...
class SaloonImageSerializer(serializers.ModelSerializer):
    # Return full URL
...
class SaloonServiceSerializer(serializers.ModelSerializer):
    ...
    multi_images = SaloonImageSerializer(many=True, required=False)
    ...
    def get_category(self, obj):
        if obj.vendor and obj.vendor.vendor_subtype:
            return obj.vendor.vendor_subtype   # ✅ DIRECT STRING
