# services/serializers/finance_serializers.py
...
class FinanceServiceImageSerializer(serializers.ModelSerializer):
    image = serializers.SerializerMethodField()

    class Meta:
        model = FinanceServiceImage
        fields = ['id', 'image']
...
class FinanceServiceSerializer(serializers.ModelSerializer):
    ...
    multi_images = FinanceServiceImageSerializer(many=True, required=False)
